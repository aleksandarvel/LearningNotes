...
import com.notes.learning.subscribedatabase.SubscribeTodoDatabaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subscribe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cursor c = getContentResolver().query(MyTodoContentProvider.CONTENT_URI, null, TodoTable.COLUMN_TOPIC + " = " + DatabaseUtils.sqlEscapeString(topic), null, null);

                SubscribeTodoDatabaseHelper db = new SubscribeTodoDatabaseHelper(getApplicationContext());
                if(c.getCount() == 0) {
                ...
                {
                    Toast.makeText(getApplicationContext(),"You are already subscribed on topic "+topic, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
